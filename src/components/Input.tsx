  ...
  return (
    <div className='relative w-full max-w-md'>
      <input
        ...
        value={value}
        onChange={onChange}
        className='h-full w-full rounded-2xl border-2 border-white/5 bg-transparent px-4 py-3 text-white placeholder:text-gray-500 focus:border-white/5 focus:outline-none'
      />
